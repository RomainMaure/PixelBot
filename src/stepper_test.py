...
# Define pins
STEP_PIN_MOT_1 = 16
DIRECTION_PIN_MOT_1 = 21

STEP_PIN_MOT_2 = 26
DIRECTION_PIN_MOT_2 = 13
...
stepperHandlerMot1 = StepperHandler(STEP_PIN_MOT_1, DIRECTION_PIN_MOT_1, 0.0025)
stepperHandlerMot2 = StepperHandler(STEP_PIN_MOT_2, DIRECTION_PIN_MOT_2, 0.0025)

# Go forwards once
stepperHandlerMot1.Step(200)
stepperHandlerMot2.Step(200)

# Go backwards once
stepperHandlerMot1.Step(200, stepperHandlerMot1.ANTI_CLOCKWISE)
stepperHandlerMot2.Step(200, stepperHandlerMot2.ANTI_CLOCKWISE)
